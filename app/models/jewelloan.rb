...
has_many :jltransactions

accepts_nested_attributes_for :jltransactions, :allow_destroy => true

attr_accessible :account_number, :customer_name, :customer_address, :set_opened_on, :due_date, :amount, :jewel, :no_of_items, :gross_weight, :net_weight, :appraised_amount, :loan_amount, :transaction_mode, :transaction_type, :particulars, :comments, :jltransactions_attributes
...
before_save :amount_due
  def amount_due
    self.amount_due = ((self.loan_amount.round * 0.18 * 15)/365).round + self.loan_amount
  end  

validates :customer_name, presence: true
validates_numericality_of  :no_of_items
validates :jewel, :no_of_items, :gross_weight, :net_weight, :appraised_amount, :loan_amount, :transaction_mode, :transaction_type, :particulars, presence: true
